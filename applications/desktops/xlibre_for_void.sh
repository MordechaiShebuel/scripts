#!/usr/bin/env bash
# TODO: BUG: there is something amiss with this setup, it will not load X after reboot.
...
printf "repository=https://github.com/xlibre-void/xlibre/releases/latest/download/" | sudo tee /etc/xbps.d/98-repository-xlibre.conf
